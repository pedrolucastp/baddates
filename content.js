const content = {
    ...
    author: {
        ...
        bio: `Estela Rocha escreve assim como quem precisa respirar. Nascida em Porto Alegre (RS) em 1986, aprendeu a amar as palavras desde cedo,  pois assim entendeu a importância das formas de comunicar ao mundo o que e como sente as coisas.  
...
Estela é mulher cis, mãe da Lina, ativista feminista e agora, escritora.`,
    ...
    about: {
        ...
        cover: "cover-1.jpg",
        description: `
            Após mais de 10 anos mergulhada em histórias de amor, desamores, flertes, paixões e desapaixões, decidi reunir alguns fragmentos e contos dos meus <i>Bad Dates</i> em um só lugar.
            Estas narrativas, escritas entre 2014 e 2020 e concluídas em maio de 2024, revelam nuances dos meus relacionamentos, sendo eles reais ou imaginados. Emprestados ou roubados. Mas sempre todos muito meus.`,
        thanks: `Apoie esta iniciativa independente adquirindo o livro em versão digital no momento.`,
...
A verdade toda é que eu invento mil formas para te esperar, por que já espero sem desculpa nenhuma tu bater na minha porta, de mala e cuia e de peito aberto. E eu de pijama e chá quente na mão, como no fim de um filme romântico, bem cafona e bem clichê, me surpreenda que abaixo de chuva torrencial e ao som de um pop chiclete, abra a porta, os braços e te veja, enfim, chegar pra ficar.`,
        ...
        {
            title: `Felicidade do dia`,
            text: `O teu nome não cabe numa lata de Coca-Cola.`,
...
Eu gosto de deixar rastros.`,
        ...
        {
            title: `A ilha rosa, amarela, azul e seda.`,
            text: `Nem toda despedida é em tom pastel.`,
            short_sentence: `Nem toda despedida é em tom pastel`
        },
        {
            title: `Angkor Wat`,
